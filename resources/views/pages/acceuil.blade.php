...
@section('content')
    ...
    @endif
    <img src="{{ URL::asset('img/test.png') }}" style="width: 100%; height:40%;" alt="not found">
    <p class="mt-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. At blanditiis, aliquam sapiente ipsa
    ...
    <div class="d-flex flex-row  justify-content-between ">
        @foreach ($trecks as $treck)
            <div class="d-flex flex-row border border-2 my-3 me-3 rounded-3" style="width:30rem; height:18.8rem;">
